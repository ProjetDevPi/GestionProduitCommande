...
tb.addCommandToLeftSideMenu("Abscence", theme.getImage("abscence.png"),  e -> {try {
    new ProfilUser(current).show();
...
tb.addCommandToLeftSideMenu("Consulter Produits", theme.getImage("produits.png"), e -> {try {
    new AffichageProduit(current).show();
                } catch (ParseException ex) {
                  
                }}); 
tb.addCommandToLeftSideMenu("Panier", theme.getImage("panier.png"), e -> {try {
...
tb.addCommandToLeftSideMenu("Evenements", theme.getImage("evenements.png"), e -> {});
tb.addCommandToLeftSideMenu("Reclamation", theme.getImage("evenements.png"), e -> {});
