    ...
    public static ServiceUser getInstance() {
        ...
        */
        ...
        return log;
         ...
         public login login() {       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/dev/web/app_dev.php/sarra");  
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                ServiceUser ser = new ServiceUser();
...
FosUser e = new FosUser();
  ...
  public ArrayList<FosUser> FosUser2(String username) {       
    ...
    ///////////////parse fos sans param//////////
  
   public ArrayList<FosUser> parseFos2(String json) throws IOException {
...
FosUser e = new FosUser();
      ...
      /////////////////////profil////////////////////////////////////////////////
         ...
         public ArrayList<FosUser> profil(){
                login l =new login();
              l=login();
        String url = "http://localhost/dev/web/app_dev.php/profil/"+l.getId_user();
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            ...
            public void actionPerformed(NetworkEvent evt) {
                try {
                    allusers = parseFos2(new String(req.getResponseData()));
                } catch (IOException ex) {
