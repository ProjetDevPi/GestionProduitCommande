...
public class Produit {
    ...
    public Produit(int id, int categorie, String nom, double prix, String description, String nom_image, int quantite, ImageView photo) {
        this.id = id;
    ...
    public String toString() {
        return "Produit{" + "id=" + id + ", categorie=" + categorie + ", nom=" + nom + ", prix=" + prix + ", description=" + description + ", nom_image=" + nom_image + ", quantite=" + quantite + '}';
    }
